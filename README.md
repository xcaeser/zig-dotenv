...
[![Version](https://img.shields.io/badge/dotenv-v0.7.1-green)](https://github.com/xcaeser/zig-dotenv/releases)
...
```bash
zig fetch --save=dotenv https://github.com/xcaeser/zig-dotenv/archive/v0.7.1.tar.gz
```
